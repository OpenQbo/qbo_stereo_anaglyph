/* Auto-generated by genmsg_cpp for file /opt/ros/electric/stacks/hrl/hrl_lib/msg/PlanarBaseVelLimits.msg */
...
{
template<class ContainerAllocator> struct IsMessage< ::hrl_lib::PlanarBaseVelLimits_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct IsMessage< ::hrl_lib::PlanarBaseVelLimits_<ContainerAllocator>  const> : public TrueType {};
template<class ContainerAllocator>
