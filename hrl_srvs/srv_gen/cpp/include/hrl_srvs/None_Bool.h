/* Auto-generated by genmsg_cpp for file /opt/ros/electric/stacks/hrl/hrl_srvs/srv/None_Bool.srv */
...
{
template<class ContainerAllocator> struct IsMessage< ::hrl_srvs::None_BoolRequest_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct IsMessage< ::hrl_srvs::None_BoolRequest_<ContainerAllocator>  const> : public TrueType {};
template<class ContainerAllocator>
...
namespace message_traits
{
template<class ContainerAllocator> struct IsMessage< ::hrl_srvs::None_BoolResponse_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct IsMessage< ::hrl_srvs::None_BoolResponse_<ContainerAllocator>  const> : public TrueType {};
template<class ContainerAllocator>
